...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <!-- End Navbar -->
   <form class="input-group input-group-outline" id="searchForm" method="get" action="/board/boardList">
          ...
          <div class="card my-4">
			...
			<div class="card-body px-0 pb-2">
			  <div class="row">
					<div class="col-md-6">
				<c:if test="${not empty login }"> 
						<button type="button" id="boardInBtn" class="btn btn-outline-secondary">게시판 작성하기</button>
				</c:if>
					</div>
				<div class="col-md-1">
				...
				<div class="col-md-3">
				  <div class="ms-md-auto">
					  ...
					  <input name="searchWord" id="searchWord" type="text" class="form-control" value="${searchWord }">
				  </div>
				</div>
				<div class="col-md-2">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <c:set value="${pageVO.dataList }" var="boardList"/>
                  		<c:choose>
                  			...
                  			<c:otherwise>
                  				<c:forEach items="${boardList }" var="board">
                  				 <tr class="text-center" id="idList">
		                 	     <td>${board.bono }</td>
