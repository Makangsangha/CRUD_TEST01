...
<body class="g-sidenav-show  bg-gray-200">
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="card card-plain h-100">
				...
				<c:if test="${not empty login and login.memId == board.bowriter }">
  ...
  <form action="/board/boardUpdateForm" id="updateDelteForm" method="get">
	...
	$(function(){
		...
		deleteBtn.on("click", function(){
			if(confirm("정말 삭제하시겠습니까?")){
				// 삭제 처리
				$("#updateDelteForm").attr("action", "/board/deleteBoard")
				$("#updateDelteForm").attr("method", "post")
				$("#updateDelteForm").submit();
			}else{
				// 삭제 취소
				$("#updateDelteForm").reset();
			}
		})
		
		updateBtn.on("click", function(){
			$("#updateDelteForm").attr("action", "/board/boardUpdateForm")
			$("#updateDelteForm").attr("method", "get")
			$("#updateDelteForm").submit();
		})
	})
